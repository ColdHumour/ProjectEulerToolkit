...
Function list: 
    isSquare, factorial, padic, cprod, ggcd
    sumMod, powerMod, iterAsso
    pythagTripleTree
    coPrimeTree
    sternBrocotTree
    cfracRNExpand, cfracINExpand, cfracConvergent
    maxSubarray
...
def ggcd(seq):
    """
    return the greatest common divisor (gcd) for n integers, where n can larger than 2
    """
...
def pythagTripleTree(triple=(3, 4, 5), forward=True, trust=False):
    """
...
def coPrimeTree(pair=(0, 0), trust=False):
    """
...
def cfracRNExpand(p, q=1, limit=100):
    """
...
def cfracINExpand(d, p=0, q=1, limit=100):
    """
